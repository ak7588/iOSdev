...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) -> Int {
        if userChoice == stories[storiesCount].choice1 {
            storiesCount = stories[storiesCount].choice1Destination
        }
        if userChoice == stories[storiesCount].choice2 {
            storiesCount = stories[storiesCount].choice2Destination
        }
        return storiesCount
    }
